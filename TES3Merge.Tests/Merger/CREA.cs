...
/// </summary>
[TestClass]
public class CREA : RecordTest<TES3Lib.Records.CREA>
{
    internal TES3Lib.Records.CREA MergedDefault;
    ...
    public CREA()
    {
        MergedDefault = CreateMergedRecord("alit", AddedMergeMasters);
    ...
    public void Inventory()
    {
        ...
        void LogRecordsInventory(TES3Lib.Records.CREA merged, params string[] plugins)
        {
    ...
    public void AIPackages()
    {
        ...
        void LogRecordsAIPackages(TES3Lib.Records.CREA merged, params string[] plugins)
        {
            foreach (var parent in plugins)
            {
                var plugin = RecordCache[parent];
